...
4. **Apply the theme**: Apply the selected theme's colors and fonts to the deck/artifact
...
To handle cases where none of the existing themes work, create a custom theme based on provided inputs. Generate a new theme similar to the ones above, give it a descriptive name, show it for review, then apply it.
